...
// }
// TEST_CASE("custom reverseN", "[weight=10][part=2]") {
//   List<unsigned> firstList;
//   firstList.insertBack(1);
//   firstList.insertBack(2);
//   firstList.insertBack(3);
...
//   firstList.insertBack(8);
//   firstList.insertBack(9);
//   firstList.insertBack(10);

//   cout << firstList << endl;
//   firstList.reverseNth(3);
//   cout << firstList << endl;
// }
// TEST_CASE("custom reverse", "[weight=10][part=2]") {
//   List<unsigned> firstList;
//   firstList.insertBack(1);
//   firstList.insertBack(2);
//   firstList.insertBack(3);
...
//   cout << firstList << endl;
// }
// TEST_CASE("custom reversek", "[weight=10][part=2]") {
//   List<unsigned> firstList;
//   firstList.insertBack(1);
//   firstList.insertBack(2);
//   firstList.insertBack(3);
...
//   it++;
//   it++;
//   firstList.reverse(firstList.begin(), it);
//   cout << firstList << endl;
// }