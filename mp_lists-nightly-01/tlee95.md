...
==20966== Copyright (C) 2002-2015, and GNU GPL'd, by Julian Seward et al.
==20966== Using Valgrind-3.11.0 and LibVEX; rerun with -h for copyright info
==20966== Command: ./test -r xml "List::insertFront\ size"
==20966== 
==20966== Conditional jump or move depends on uninitialised value(s)
==20966==    at 0x435DDC: List<int>::insertFront(int const&) (List.hpp:55)
==20966==    by 0x430257: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:23)
==20966==    by 0x472832: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==20966==    by 0x462F86: Catch::TestCase::invoke() const (catch.hpp:10793)
==20966==    by 0x462EBC: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
==20966==    by 0x45F416: Catch::RunContext::runCurrentTest(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&, std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&) (catch.hpp:9622)
==20966==    by 0x45D9EE: Catch::RunContext::runTest(Catch::TestCase const&) (catch.hpp:9408)
==20966==    by 0x466D86: Catch::(anonymous namespace)::runTests(std::__1::shared_ptr<Catch::Config> const&) (catch.hpp:9948)
==20966==    by 0x465A22: Catch::Session::runInternal() (catch.hpp:10149)
==20966==    by 0x4656EA: Catch::Session::run() (catch.hpp:10106)
==20966==    by 0x465669: Catch::Session::run(int, char**) (catch.hpp:10074)
==20966==    by 0x4926E1: main (catch.hpp:13613)
==20966== 
==20966== Conditional jump or move depends on uninitialised value(s)
==20966==    at 0x435E16: List<int>::insertFront(int const&) (List.hpp:58)
==20966==    by 0x430257: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:23)
==20966==    by 0x472832: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==20966==    by 0x462F86: Catch::TestCase::invoke() const (catch.hpp:10793)
==20966==    by 0x462EBC: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
...
==20966== 
==20966== Conditional jump or move depends on uninitialised value(s)
==20966==    at 0x463030: Catch::RunContext::handleExpr(Catch::AssertionInfo const&, Catch::ITransientExpression const&, Catch::AssertionReaction&) (catch.hpp:9683)
==20966==    by 0x440F0B: Catch::AssertionHandler::handleExpr(Catch::ITransientExpression const&) (catch.hpp:5467)
==20966==    by 0x4303B4: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:25)
==20966==    by 0x472832: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==20966==    by 0x462F86: Catch::TestCase::invoke() const (catch.hpp:10793)
==20966==    by 0x462EBC: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
==20966==    by 0x45F416: Catch::RunContext::runCurrentTest(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&, std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&) (catch.hpp:9622)
...
==20966== 
==20966== HEAP SUMMARY:
==20966==     in use at exit: 240 bytes in 10 blocks
==20966==   total heap usage: 2,328 allocs, 2,318 frees, 267,368 bytes allocated
==20966== 
==20966== 240 bytes in 10 blocks are definitely lost in loss record 1 of 1
==20966==    at 0x4C29BE3: malloc (vg_replace_malloc.c:299)
==20966==    by 0x4E5A9C4: operator new(unsigned long) (in /clang+llvm-6.0.1-x86_64-linux-sles11.3/lib/libc++abi.so.1.0)
==20966==    by 0x435D93: List<int>::insertFront(int const&) (List.hpp:51)
==20966==    by 0x430257: ____C_A_T_C_H____T_E_S_T____0() (tests_part1.cpp:23)
==20966==    by 0x472832: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==20966==    by 0x462F86: Catch::TestCase::invoke() const (catch.hpp:10793)
==20966==    by 0x462EBC: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
...
==20966== 
==20966== LEAK SUMMARY:
==20966==    definitely lost: 240 bytes in 10 blocks
...
==20966== Use --track-origins=yes to see where uninitialised values come from
==20966== ERROR SUMMARY: 13 errors from 4 contexts (suppressed: 0 from 0)
...
==21003== Using Valgrind-3.11.0 and LibVEX; rerun with -h for copyright info
==21003== Command: ./test -r xml "List::_destroy\ empty\ list"
==21003== 
==21003== 
==21003== HEAP SUMMARY:
==21003==     in use at exit: 0 bytes in 0 blocks
==21003==   total heap usage: 2,336 allocs, 2,336 frees, 268,200 bytes allocated
==21003== 
